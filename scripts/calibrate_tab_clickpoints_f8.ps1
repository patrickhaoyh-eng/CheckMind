...
$env:CHECKMIND_CALIBRATE_TAB_CLICKPOINTS = "1"
Remove-Item Env:\CHECKMIND_CALIBRATE_REUSE_EXISTING -ErrorAction SilentlyContinue
$env:CHECKMIND_TESTLAB_TABS = "Channel Setup,Sine Setup"
$env:CHECKMIND_CALIBRATE_VERIFY_STABLE_CONSECUTIVE = "2"
$env:CHECKMIND_CALIBRATE_VERIFY_SAMPLE_COUNT = "4"
$env:CHECKMIND_CALIBRATE_VERIFY_SAMPLE_SLEEP_MS = "80"
...
Write-Host "Starting ClickPoint + verify-signature calibration (F8)..."
