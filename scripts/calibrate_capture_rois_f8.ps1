...
$env:CHECKMIND_CALIBRATE_CAPTURE_ROI = "1"
Remove-Item Env:\CHECKMIND_CALIBRATE_TAB_CLICKPOINTS -ErrorAction SilentlyContinue
...
Write-Host "Starting capture ROI calibration (F8 corners)..."
