...
$env:CHECKMIND_CHILD_WINDOW_KEY = "advanced_control_setup"
$env:CHECKMIND_CHILD_WINDOW_TITLE_CONTAINS = "Advanced Control Setup"
...
Write-Host ("CHECKMIND_CHILD_WINDOW_TITLE_CONTAINS=" + $env:CHECKMIND_CHILD_WINDOW_TITLE_CONTAINS)
Write-Host "Starting child-window calibration: advanced_control_setup"
