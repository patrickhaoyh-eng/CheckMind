...
$env:CHECKMIND_CHILD_WINDOW_KEY = "define_notch_profiles_layout_signature"
...
Write-Host "Starting child-window calibration: define_notch_profiles_layout_signature"
