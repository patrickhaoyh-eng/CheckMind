...
$env:CHECKMIND_CHILD_WINDOW_KEY = "profile_editor"
$env:CHECKMIND_CHILD_WINDOW_TITLE_CONTAINS = "Profile Editor"
...
Write-Host "Starting child-window calibration: profile_editor"
